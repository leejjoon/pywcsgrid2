...
class Divider(object):
    ...
    (:mod:`pywcsgrid2.axes_grid.axes_size`) that the division will
    ...
    def __init__(self, fig, pos, horizontal, vertical, aspect=None, anchor="C"):
        ...
        :param horizontal: list of sizes
                    (:mod:`~pywcsgrid2.axes_grid.axes_size`)
    ...
    def new_locator(self, nx, ny, nx1=None, ny1=None):
        ...
        (:class:`pywcsgrid2.axes_grid.axes_divider.AxesLocator`) for
        specified cell.
...
class AxesDivider(Divider):
    ...
    def new_horizontal(self, size, pad=None, pack_start=False, **kwargs):
        ...
        :param size: A width of the axes. A :mod:`~pywcsgrid2.axes_grid.axes_size`
    ...
    def new_vertical(self, size, pad=None, pack_start=False, **kwargs):
        ...
        :param size: A height of the axes. A :mod:`~pywcsgrid2.axes_grid.axes_size`
          instance or if float or string is given, *from_any*
          fucntion is used to create one, with *ref_size* set to AxesX instance
          of the current axes.
        :param pad: pad between the axes. It takes same argument as *size*.
